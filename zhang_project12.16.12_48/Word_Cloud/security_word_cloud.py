...
def Security_Word_Cloud(dateBegin,dateEnd):
    ...
    for sentence in clean_lines:
        ...
        # Key_word1 = jieba.cut(sentence, cut_all=False)
        # print(.join(Key_word1))
        # Key_word.append(Key_word)
    # print(Key_word)
    # print("123" + "/".join(Key_word))
...
e = Security_Word_Cloud('2017-07-22', '2017-08-23')
print(e)
#
