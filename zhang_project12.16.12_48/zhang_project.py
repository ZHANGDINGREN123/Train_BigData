...
from config_S_HANDLEREASULT import show_handler_result_value_counts,get_year,get_month
...
def index():
    if request == 'GET':
        ...
        # show_S_HANDLEREASULT = FirstLayer.first_layer("2017","07","22","2017","08","23")
...
def index2():
    if request == 'GET':
        ...
        # EmployerCode = request.form.get('Department_Type_two')
        # Responsibli_Preson = request.form.get('Responsibli_Preson_two')
        # # print(dateBegin,dateEnd)
        # Show_S_RESPONSIBILITYDEPT = DepartmHandResult.getHandResultByDepartm("行包车间","2017","05","22","2017","08","23")
        # # show_S_HANDLEREASULT = FirstLayer.first_layer("2017","07","22","2017","08","23")
        # show_S_HANDLEREASULT = FirstLayer.first_layer(dateBegin,dateEnd)
